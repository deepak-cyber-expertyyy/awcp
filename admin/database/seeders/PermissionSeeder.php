...
class PermissionSeeder extends Seeder
{
    public function run()
    {
        ...
        $permissionsToSeed = [ 
            ...
            /*customer*/
            [
                'name' => ['customer_list','customer_update','manage_wishlists','transaction_list','manage_customer_wallet','product_request_list','product_request_update','product_request_delete'],

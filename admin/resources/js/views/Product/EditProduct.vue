                                ...
                                placeholder: __('enter_product_tag'), }" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mt-3">
                                            <button
                                                type="button"
                                                class="btn btn-outline-primary mt-2 ai-generate-btn"
                                                ...
                                                <template v-if="isGeneratingAI">
                                                    ...
                                                    <span class="ai-text-animate">AI is generating...</span>
                                                </template>
                                                <!-- Normal State -->
                                                <template v-else>
...
export default {
    ...
    createSlug() {
            ...
            axios.get(this.$apiUrl + '/products/brands/get')
                .then((response) => {
                    ...
                    if (this.cachedData && this.cachedData.brand) {
                        this.brand = this.brands.find(b => b.id === this.cachedData.brand.id) || null;
                    }
                });
        },
        getCountries() {
        ...
        saveCache: function() {
            ...
            try {
                const data = {
                    ...
                    return_days: this.return_days, cancelable_status: this.cancelable_status,
                    ...
                    customPrompt: this.customPrompt, timestamp: Date.now()
                };
        ...
        restoreCache: function() {
            try {
                ...
                if (data.brand && this.brands && this.brands.length) {
                    this.brand = this.brands.find(b => b.id === data.brand.id) || null;
                }
        ...
        clearForm: function() {
            ...
            Object.assign(this, {
                ...
                made_in: null, return_status: 0, return_days: 0, cancelable_status: 0,
    ...
    watch: {
        ...
        manufacturer: function() { if (!this.id && !this.clone) this.debouncedSave(); },
        made_in: { handler: function() { if (!this.id && !this.clone) this.debouncedSave(); }, deep: true },
        return_status: function() { if (!this.id && !this.clone) this.debouncedSave(); },
        return_days: function() { if (!this.id && !this.clone) this.debouncedSave(); },

          ...
          <div class="card">
            <div class="card-header">
              ...
              <span class="pull-right">
                <button class="btn btn-primary" @click="edit_record=true" v-if="$can('time_slot_create')" v-show="timeSlot_settingsObject.time_slots_is_enabled == 1">{{ __('add_new_time_slot') }}</button>
              </span>
            </div>
                ...
                <div class="col-md-4">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="checkbox" id="time_slot_setting" v-model="timeSlot_settingsObject.time_slot_setting" class="form-check-input" :value="1">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="checkbox" required id="time_slots_is_enabled" v-model="timeSlot_settingsObject.time_slots_is_enabled" class="form-check-input" :value="0" :disabled="!timeSlot_settingsObject.time_slot_setting">
                    </div>
                ...
                <div class="col-md-8" v-if="timeSlot_settingsObject.time_slots_is_enabled == 1">
                  ...
                  >
                      ...
                      <template #cell(is_free_delivery)="row">
                          <span class='badge bg-success' v-if="row.item.is_free_delivery == 1">{{ __('yes') }}</span>
                          <span class='badge bg-secondary' v-if="row.item.is_free_delivery == 0">{{ __('no') }}</span>
                      </template>

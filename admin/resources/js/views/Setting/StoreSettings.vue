                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="form-check form-switch">
                                        <input type="checkbox" true-value="1" false-value="0" class="form-check-input"
                                            ...
                                            <span class="text text-primary font-size-13"> ( {{ __('enable_and_disable_product_rating_system') }} ) </span>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="few_quantity_left_alert">{{ __('few_quantity_left_alert') }}</label>
                                    <input type="number" class="form-control" name="few_quantity_left_alert"
                                           id="few_quantity_left_alert" v-model="store_settings.few_quantity_left_alert"
                                           placeholder='Few Quantity Left Alert' min='1'/>
                                    <span class="text text-primary font-size-13"> ( {{ __('will_show_few_quantity_left_in_product_cart') }} ) </span>
                                </div>
                                            ...
                                            <form method="post" enctype="multipart/form-data" @submit.prevent="saveSellerSetting">
                                                <div class=" row -align-items-center"  >
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="number" class="form-control" name="seller_commission" id="seller_commission" v-model="store_settings.seller_commission" placeholder="Seller Commission" step="0.1" min="0" max="100">
                                                    </div>
...
export default {
    ...
    methods: {
        ...
        saveThirdPartyApiSetting: function () {
            ...
            const apiFields = ['google_place_api_key', 'google_map_api_key', 'googleMapApiKey', 'text_gen_key'];

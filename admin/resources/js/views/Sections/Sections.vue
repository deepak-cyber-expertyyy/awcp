                        ...
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{
                                    __('featured_section_to_show_product_exclusively') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card-header">
                        ...
                        <span class="pull-right">
                            <button class="btn btn-primary" @click="create_new = true"
                                v-if="$can('featured_section_create')">{{ __('add_sections') }}</button>
                        </span>
                    </div>
                    <div class="card-body">
                        ...
                        <b-table :items="sections" :fields="fields" :current-page="currentPage" :per-page="perPage"
                            ...
                            <template #cell(actions)="row">
                                ...
                                <button class="btn btn-sm btn-danger" @click="deleteSection(row.index, row.item.id)"
                                    v-if="$can('featured_section_delete')" v-b-tooltip.hover :title="__('delete')"><i

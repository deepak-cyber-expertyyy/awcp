                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <router-link to="/seller"
                                    v-if="this.$roleSeller === this.login_user.role.name">{{ __('dashboard') }}</router-link>
                            ...
                            <div class="card-header">
                                ...
                                <span class="pull-right" v-if="this.$roleSeller !== this.login_user.role.name">
                                    <router-link to="/sellers" class="btn btn-primary" v-b-tooltip.hover
                                        title="Manage Seller">{{ __('manage_seller') }}</router-link>
                                </span>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12" v-if="id && this.$roleSeller !== this.login_user.role.name">
                                        <div class="row">
                                            ...
                                            <div v-if="[2, 3, 4].includes(status)" class="form-group col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" v-model="street" readonly
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <small
                                                        class="text-muted">{{ __('store_timings_description') }}</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
export default {
    ...
    watch: {
        ...
        name: function () { if (!this.id) this.debouncedSave(); },
    ...
    methods: {
        ...
        saveCache: function () {
            ...
            try {
                const data = {
                    name: this.name, email: this.email, mobile: this.mobile, store_url: this.store_url,
                    store_name: this.store_name, street: this.street, pincode_id: this.pincode_id,
                    ...
                    formatted_address: this.formatted_address, store_description: this.store_description,

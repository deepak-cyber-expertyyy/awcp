                        ...
                        <li class="nav-item dropdown me-1">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end notification-dropdown" aria-labelledby="dropdownMenuButton">
                                ...
                                <li class="dropdown-item notification-item" v-for="notification of notifications.slice(0,4)">
                                    <a class="d-flex align-items-start" @click="markAsReadNotification(notification)">

                                        <div class="notification-text w-100">
                                            <p class="notification-title font-bold mb-1"> 
                                                <a @click="handleNotificationClick(notification)" style="cursor: pointer;"> {{notification.data.text}}</a>
                                            </p>
                                            <p class="notification-subtitle font-thin text-sm mb-0">{{ changeDateTime(notification.created_at) }}</p>
                                        </div>
                                    </a>
                                </li>
                                <li v-if="notifications.length>0">
                                    ...
                                    <div class="d-flex flex-column gap-2 px-3 py-2">
                                        ...
                                        <button 
                                            v-if="notifications_unread_count > 0"
                                            class="btn btn-sm btn-primary w-100" 
                                            @click="confirmMarkAllAsRead">
                                            <i class="bi bi-check-all me-1"></i>Read all notifications
                                        </button>

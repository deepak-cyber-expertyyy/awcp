  ...
  computed: {
    tagsOptions: function tagsOptions() {
      return this.tags.length ? this.tags.map(function (tag) {
        var _tag$id;
        return {
          id: (_tag$id = tag.id) === null || _tag$id === void 0 ? void 0 : _tag$id.toString(),
          text: tag.name
        };
      }) : [];
    },
    tagSelectSettings: function tagSelectSettings() {
      return {
        tags: true,
        multiple: true,
        width: '100%',
  ...
  methods: {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().get(_this3.$apiUrl + '/blog_tags');
              case 3:
              ...
              case 7:
                ...
                console.error('Error fetching blog tags:', _context3.t0);
              case 10:
              case "end":
    ...
    saveBlog: function saveBlog(event) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee4() {
        var form, firstInvalid, formData, tagIdsValue, response;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 6:
                ...
                formData.append('slug', _this4.form.slug);
                formData.append('category_id', _this4.form.category_id);
                formData.append('description', _this4.form.description);
                formData.append('short_description', _this4.form.short_description || '');
                // Handle tag_ids - can be array or string, convert to comma-separated string
                tagIdsValue = '';
                if (Array.isArray(_this4.tag_ids)) {
                  tagIdsValue = _this4.tag_ids.filter(function (id) {
                ...
                } else if (typeof _this4.tag_ids === 'string' && _this4.tag_ids.trim() !== '') {
                  tagIdsValue = _this4.tag_ids.trim();
                }
                formData.append('tag_ids', tagIdsValue);
                formData.append('meta_title', _this4.form.meta_title);
                formData.append('meta_keywords', _this4.form.meta_keywords);
                formData.append('meta_description', _this4.form.meta_description);
                formData.append('status', _this4.form.status);
                if (_this4.form.image) {
                  formData.append('image', _this4.form.image);
                }
                if (!_this4.edit_record.id) {
                  _context4.next = 28;
                  break;
                }
                _context4.next = 25;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().post(_this4.$apiUrl + "/blogs/update/".concat(_this4.edit_record.id), formData, {
                  headers: {
              ...
              case 28:
                _context4.next = 30;
                return axios__WEBPACK_IMPORTED_MODULE_2___default().post(_this4.$apiUrl + '/blogs/save', formData, {
                  headers: {
                    'Content-Type': 'multipart/form-data'
                  }
                });
              ...
              case 31:
                if (response.data.status === 1) {
                  ...
                  _this4.create_new = false;
                  _this4.resetForm();
                  _this4.getBlogs();
                  _this4.getTags();
                } else {
                  _this4.showError(response.data.message);
                }
                _context4.next = 37;
                break;
              case 34:
              ...
              case 0:
                _this5.$swal.fire({
                  ...
                  if (result.value) {
                    ...
                    axios__WEBPACK_IMPORTED_MODULE_2___default().post(_this5.$apiUrl + "/blogs/delete/".concat(id)).then(function (response) {
      ...
      handler: function handler(newVal) {
        ...
        if (newVal.id) {
          ...
          if (Array.isArray(newVal.tag_ids)) {
            this.tag_ids = newVal.tag_ids.map(function (tagId) {
          ...
          this.$nextTick(function () {
            _this6.updateDescriptionValidation();
          });
          this.create_new = true;
      ...
      _c(
        ...
        [
          _c(
            "form",
            {
              attrs: { enctype: "multipart/form-data", id: "blog-form" },
              on: {
                        ...
                        [
                          _vm._v(
                            _vm._s(_vm.__("tags")) +
                              " ( " +
                              _vm._s(
                                _vm.__("these_tags_help_you_in_search_result")
                              ) +
                              " )"
                          ),
                        ]
                ...
                _c("div", { staticClass: "col-md-12" }, [
                  _c("div", { staticClass: "form-group" }, [
                    _c("label", { attrs: { for: "short_description" } }, [
                      _vm._v(_vm._s(_vm.__("short_description"))),
                    ]),
                    _vm._v(" "),
                    _c("textarea", {
                      directives: [
                    ...
                    _vm._v(" "),
                    _c("small", { staticClass: "text-muted" }, [
                      _vm._v(_vm._s(_vm.__("short_description_help_text"))),
                    ]),
                  ]),
                ]),
              ]),

...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      is_free_delivery: this.record ? this.record.is_free_delivery || 0 : 0,
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().get(_this.$apiUrl + '/delivery_settings/check_active_subscription_plans');
              case 3:
                response = _context.sent;
                if (response.data.status === 1) {
                  _this.hasActiveSubscriptionPlans = response.data.data.has_active_subscription_plans;
                }
                _context.next = 10;
                break;
              case 7:
                ...
                console.error('Error checking active subscription plans:', _context.t0);
              case 10:
              case "end":
    ...
    saveRecord: function saveRecord() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().post(url, formData, {
        ...
        var data = res.data;
        if (data.status === 1) {
          _this2.$eventBus.$emit('TimeSlotsSaved', data.message);
          _this2.hideModal();
        } else {
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "row" }, [
            ...
            _vm._v(" "),
            _c("div", { staticClass: "form-group" }, [
              _c("label", [_vm._v(_vm._s(_vm.__("free_delivery")))]),
              _vm._v(" "),
              _c("div", { staticClass: "col-md-9 text-left mt-1" }, [
                _c("div", { staticClass: "position-relative d-inline-block" }, [
                  _c("input", {
                    ...
                    domProps: {
                      value: 1,
                      checked: Array.isArray(_vm.is_free_delivery)
                        ? _vm._i(_vm.is_free_delivery, 1) > -1
                    ...
                    on: {
                      change: function ($event) {
                        ...
                        if (Array.isArray($$a)) {
                          ...
                          if ($$el.checked) {
                            $$i < 0 &&
                              (_vm.is_free_delivery = $$a.concat([$$v]))
                          } else {
                            $$i > -1 &&
                  ...
                  _c(
                    "label",
                    {
                      ...
                      class: { "text-muted": _vm.hasActiveSubscriptionPlans },
                          ...
                          [
                            ...
                            _c(
                              ...
                              [
                                _vm._v(
                                  "\n                        " +
                                    _vm._s(_vm.__("go_to_subscriptions")) +
                                    " "
                                ),
                                _c("i", {

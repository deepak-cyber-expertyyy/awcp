  ...
  methods: {
    ...
    markAllAsRead: function markAllAsRead() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/notification_read').then(function (response) {
        ...
        _this8.getNotifications();
        // Show success message
        _this8.showMessage("success", response.data.message || "All notifications marked as read");
      })["catch"](function (error) {
        // Show error message if something goes wrong
        _this8.showError("Failed to mark all notifications as read");
      });
    },
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/orders/view/' + orderId).then(function (response) {
        ...
        if (order) {
          if (order.order_type === 'selfpickup') {
            _this9.$router.push('/self_pickup_orders/view/' + orderId);
          } else {
            _this9.$router.push('/orders/view/' + orderId);
          }
        } else {
          _this9.$router.push('/orders/view/' + orderId);
        }
        ...
        [
          _c("div", { staticClass: "text-center" }, [
            ...
            _c("p", { staticClass: "text-muted" }, [
              _vm._v(
                "Your account has been blocked by admin. Please contact admin to unblock your account."
              ),
            ]),
          ]),
        ]
                          ...
                          [
                            _c(
                              ...
                              [
                                _c(
                                  "div",
                                  { staticClass: "notification-text w-100" },
                                  [
                                    _c(
                                      "p",
                                      {
                                        staticClass:
                                          "notification-title font-bold mb-1",
                                      },
                                      [
                                        _c(
                                          "a",
                                    ...
                                    _c(
                                      ...
                                      {
                                        staticClass:
                                          "notification-subtitle font-thin text-sm mb-0",
                                      },
                                      [
                                        _vm._v(
                                          _vm._s(
                    ...
                    _vm.notifications.length > 0
                      ? _c("li", [
                          ...
                          _c(
                            "div",
                            {
                              staticClass: "d-flex flex-column gap-2 px-3 py-2",
                            },
                            [

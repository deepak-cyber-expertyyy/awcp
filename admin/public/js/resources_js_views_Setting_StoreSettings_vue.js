  ...
  methods: {
    ...
    getStoreSetting: function getStoreSetting() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(url).then(function (response) {
        ...
        _this2.refer_earn_record = response.data.data.refer_earn_settings;
        _this2.refer_earn_record.map(function (item, index) {
          if (item.value === '0' || item.value === '1') {
            _this2.refer_earn_settings[item.variable] = item.value === '0' ? 0 : 1;
          } else {
            _this2.refer_earn_settings[item.variable] = item.value;
          }
        });
        ...
        if (_this2.store_settings.google_place_api_key) {
          var bytes = crypto_js__WEBPACK_IMPORTED_MODULE_4___default().AES.decrypt(_this2.store_settings.google_place_api_key, secretKey);
          _this2.store_settings.google_place_api_key = bytes.toString((crypto_js__WEBPACK_IMPORTED_MODULE_4___default().enc).Utf8);
          console.log(_this2.store_settings.google_place_api_key);
        }

        // Decrypt google_map_api_key
        if (_this2.store_settings.google_map_api_key) {
          var mapBytes = crypto_js__WEBPACK_IMPORTED_MODULE_4___default().AES.decrypt(_this2.store_settings.google_map_api_key, secretKey);
          _this2.store_settings.google_map_api_key = mapBytes.toString((crypto_js__WEBPACK_IMPORTED_MODULE_4___default().enc).Utf8);
          console.log(_this2.store_settings.google_map_api_key);
        }
    ...
    saveStoreBasicSetting: function saveStoreBasicSetting() {
      ...
      var storeBasicFields = ['system_configurations', 'system_timezone_gmt', 'system_configurations_id', 'app_name', 'support_number', 'support_email', 'copyright_details'];
      storeBasicFields.forEach(function (field) {
        if (_this3.store_settings[field] !== undefined) {
          formData.append(field, _this3.store_settings[field]);
        }
      });
      ...
      var url = this.$apiUrl + '/store_settings/save_store_basic_setting';
      var vm = this;
    ...
    saveAddressSetting: function saveAddressSetting() {
      ...
      var addressFields = ['store_address', 'map_latitude', 'map_longitude', 'currency', 'currency_code', 'decimal_point', 'system_timezone', 'default_city_id'];
      addressFields.forEach(function (field) {
        if (_this4.store_settings[field] !== undefined) {
          formData.append(field, _this4.store_settings[field]);
        }
      });
      var url = this.$apiUrl + '/store_settings/save_address_setting';
      var vm = this;
      axios__WEBPACK_IMPORTED_MODULE_0___default().post(url, formData).then(function (res) {
        var data = res.data;
        if (data.status === 1) {
    ...
    saveOtherSetting: function saveOtherSetting() {
      ...
      var otherFields = ['max_cart_items_count', 'min_order_amount', 'low_stock_limit', 'product_rating', 'few_quantity_left_alert'];
    ...
    saveAppSetting: function saveAppSetting() {
      ...
      var appFields = ['app_mode_customer', 'app_mode_customer_remark', 'app_mode_seller', 'app_mode_seller_remark', 'app_mode_delivery_boy', 'app_mode_delivery_boy_remark', 'playstore_url', 'appstore_url', 'is_version_system_on', 'required_force_update', 'current_version', 'ios_is_version_system_on', 'ios_required_force_update', 'ios_current_version'];
      appFields.forEach(function (field) {
        if (_this7.store_settings[field] !== undefined) {
          formData.append(field, _this7.store_settings[field]);
        }
      });
      var url = this.$apiUrl + '/store_settings/save_app_setting';
      var vm = this;
      axios__WEBPACK_IMPORTED_MODULE_0___default().post(url, formData).then(function (res) {
        var data = res.data;
        if (data.status === 1) {
    ...
    saveSmtpMailSetting: function saveSmtpMailSetting() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post(url, formData).then(function (res) {
        ...
        if (error.request.statusText) {
          ...
          _this9.showError("Something went wrong!");
        }
        vm.isLoading = false;
      });
    },
    ...
    saveThirdPartyApiSetting: function saveThirdPartyApiSetting() {
      ...
      var apiFields = ['google_place_api_key', 'google_map_api_key', 'googleMapApiKey', 'text_gen_key'];
      apiFields.forEach(function (field) {
        if (_this10.store_settings[field] !== undefined) {
          ...
          if ((field === "google_place_api_key" || field === "google_map_api_key") && value) {
            var secretKey = "ewgrrtoecaemr";
            value = crypto_js__WEBPACK_IMPORTED_MODULE_4___default().AES.encrypt(value, secretKey).toString();
          }
    ...
    getAdditionalCharges: function getAdditionalCharges() {
      var _this16 = this;
      var url = this.$apiUrl + '/store_settings/get_additional_charges';
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(url).then(function (response) {
        if (Array.isArray(response.data.data)) {
          _this16.additionalCharges = response.data.data.length ? response.data.data : [{
            title: '',
            amount: ''
          }];
        }
    ...
    saveAdditionalCharges: function saveAdditionalCharges() {
      var _this17 = this;
      this.isLoading = true;
      var url = this.$apiUrl + '/store_settings/save_additional_charges';
      var data = {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post(url, data).then(function (res) {
        ...
        if (data.status === 1) {
          ...
          _this17.getAdditionalCharges();
          // Hide update button if list is empty after update
          if (_this17.additionalCharges.length === 0) {
        ...
        _this17.isLoading = false;
        _this17.showError(error.message || "Something went wrong!");
      });
    }
  }
});
              ...
              _c("div", { staticClass: "vertical-tabs-container" }, [
                ...
                _c("div", { staticClass: "tab-content" }, [
                                          ...
                                          _c(
                                            "div",
                                            {
                                              ...
                                              on: {
                                                ...
                                                drop: _vm.dropFilePanelLoginackground_imgImg,
                                                dragover: _vm.$dragoverFile,
                                                dragleave: _vm.$dragleaveFile,
                                              },
                                            },
                                            ...
                                            directives: [
                                              {
                                                ...
                                                rawName: "v-model",
                                                value:
                                                  _vm.store_settings.apiKey,
                                                expression:
                                                  "store_settings.apiKey",
                                              },
                                            ],
                                            staticClass: "form-control",
                                            attrs: {
                                      ...
                                      _c(
                                        ...
                                        [
                                          _c(
                                            ...
                                            {
                                              attrs: {
                                                for: "google_map_api_key",
                                              },
                                            },
                                            [
                                              _vm._v(
                                                _vm._s(_vm.__("map_api_key"))
                                              ),
                                            ]
                                          ),
                                          _vm._v(" "),
                                            ...
                                            directives: [
                                              {
                                                ...
                                                value:
                                                  _vm.store_settings
                                                    .google_map_api_key,
                                                expression:
                                                  "store_settings.google_map_api_key",
                                              },
                                            ],
                                            staticClass: "form-control",
                                            attrs: {
                  ...
                  _vm.activeTab === _vm.__("refer_earn_setting")
                                      ...
                                      _c(
                                        ...
                                        [
                                          _vm._v(
                                            _vm._s(
                                              _vm.__(
                                                "Minimum Order Amount For Referral"
                                              )
                                            )
                                          ),
                                        ]
                                      ...
                                      _c(
                                        ...
                                        [
                                          _vm._v(
                                            _vm._s(
                                              _vm.__(
                                                "Referral Credit Amount First Order"
                                              )
                                            )
                                          ),
                                        ]
                    ...
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.activeTab === _vm.__("additional_charge")
                    ? _c("div", [
                        _c("div", { staticClass: "card" }, [
                          _c("div", { staticClass: "card-header" }, [
                            _c("h4", { staticClass: "card-title" }, [
                            ...
                            _c(
                              "form",
                              {
                                on: {
                                  submit: function ($event) {
                                    $event.preventDefault()
                                    return _vm.saveAdditionalCharges.apply(
                                      null,
                                      arguments
                                    )
                                  },
                              ...
                              [
                                    ...
                                    return _c(
                                      ...
                                      [
                                              ...
                                              directives: [
                                                {
                                                  ...
                                                  rawName: "v-model",
                                                  value: charge.title,
                                                  expression: "charge.title",
                                                },
                                              ],
                                              staticClass: "form-control",
                                              attrs: {
                                                type: "text",
                                                id: "charge_title_" + index,
                                                placeholder:
                                                  _vm.__("charge_title"),
                                                required: "",
                                              },
                                              domProps: { value: charge.title },
                                              on: {
                                                input: function ($event) {
                                                  if ($event.target.composing) {
                                                    return
                                        ...
                                        _c(
                                          ...
                                          {
                                            staticClass:
                                              "form-group col-md-2 d-flex justify-content-center align-items-center mt-2",
                                          },
                                          [
                                            _c(
                                              "button",
                                ...
                                _vm._v(" "),
                                _vm.additionalCharges.length === 0
                                  ? _c("div", { staticClass: "row" }, [
                                      _c(
                                        "div",
                                        {
                                ...
                                _vm.additionalCharges.length === 0
                                  ? _c("div", { staticClass: "row" }, [
                                      _c(
                                        ...
                                        {
                                          staticClass:
                                            "col-12 d-flex justify-content-end mt-2",
                                        },
                                        [
                                          _c(
                                            "b-button",

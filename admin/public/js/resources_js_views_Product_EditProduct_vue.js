...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    ...
    }, _defineProperty(_ref, "name", ''), _defineProperty(_ref, "description", ''), _defineProperty(_ref, "useCustomPrompt", false), _defineProperty(_ref, "customPrompt", ''), _defineProperty(_ref, "loading", false), _defineProperty(_ref, "textGenKey", ''), _ref;
  },
  computed: {
  ...
  methods: {
    generateDescription: function generateDescription() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        var prompt, _data$candidates, _data$candidates$, _data$candidates$$con, _data$candidates$$con2, _data$candidates$$con3, response, data;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this2.showMessage("error", "Please enter the product name.");
                return _context.abrupt("return");
              case 3:
                if (_this2.textGenKey) {
                  _context.next = 6;
                  break;
                }
                _this2.showMessage("error", "Text generation API key is not configured");
                return _context.abrupt("return");
              case 6:
                prompt = _this2.useCustomPrompt && _this2.customPrompt.trim() ? "".concat(_this2.customPrompt, " for product: ").concat(_this2.name, ". Output raw HTML only, no explanatory text, no code blocks, no images.") : "Generate a detailed product description for ".concat(_this2.name, " formatted for TinyMCE editor.\n            Structure: Start with <strong>Product Overview</strong>, then multiple <p> paragraphs describing features and benefits.\n            Include <strong>Key Features</strong> with <ul><li> bullet points.\n            Add <strong>Benefits</strong> section with more <p> content.\n            Use <strong> for emphasis, <em> for highlights.\n            Important: no code blocks, no markdown syntax, no explanatory text.");
                _context.prev = 7;
                _this2.isGeneratingAI = true; // Start AI processing state
                _context.next = 11;
                return fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=" + _this2.textGenKey, {
                  method: "POST",
                  headers: {
              ...
              case 14:
                ...
                if (data !== null && data !== void 0 && (_data$candidates = data.candidates) !== null && _data$candidates !== void 0 && (_data$candidates$ = _data$candidates[0]) !== null && _data$candidates$ !== void 0 && (_data$candidates$$con = _data$candidates$.content) !== null && _data$candidates$$con !== void 0 && (_data$candidates$$con2 = _data$candidates$$con.parts) !== null && _data$candidates$$con2 !== void 0 && (_data$candidates$$con3 = _data$candidates$$con2[0]) !== null && _data$candidates$$con3 !== void 0 && _data$candidates$$con3.text) {
                  _this2.description = data.candidates[0].content.parts[0].text;
                } else {
                  _this2.showMessage("error", "Failed to generate description.");
                }
                _context.next = 22;
                break;
              case 18:
                ...
                _this2.showMessage("error", "An error occurred while generating the description.");
              case 22:
                _context.prev = 22;
                _this2.isGeneratingAI = false; // Stop AI processing state
    ...
    fetchTags: function fetchTags(query) {
      ...
      if (query.length > 1) {
        axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/products/tags', {
          ...
          _this3.tagSuggestions = response.data;
    ...
    getSellerCategories: function getSellerCategories() {
      ...
      if (this.seller_id !== 0 && this.seller_id !== "") {
        ...
        axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/categories/seller_categories', {
          ...
          var data = response.data;
          _this5.categoryOptions = "<option value=\"\">--Select Category--</option>" + data;
        });
      }
    },
    getSeller: function getSeller() {
      ...
      if (this.seller_id !== 0 && this.seller_id !== "" && !this.id) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/sellers/edit/' + this.seller_id, {
          ...
          _this6.isLoading = false, _this6.require_products_approval = response.data.data.require_products_approval;
          _this6.is_approved = _this6.require_products_approval == 0 ? 1 : 0;
        });
      }
    },
    ...
    getBrands: function getBrands() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/products/brands/get').then(function (response) {
        ...
        var data = response.data;
        _this11.brands = data.data;
        if (_this11.cachedData && _this11.cachedData.brand) {
          _this11.brand = _this11.brands.find(function (b) {
            return b.id === _this11.cachedData.brand.id;
          }) || null;
        }
      });
    },
    getCountries: function getCountries() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/countries/active').then(function (response) {
        ...
        var data = response.data;
        _this12.countries = data.data;
        if (_this12.cachedData && _this12.cachedData.made_in) {
          _this12.made_in = _this12.countries.find(function (c) {
            return c.id === _this12.cachedData.made_in.id;
          }) || null;
        }
      });
    },
    ...
    getOrderStatus: function getOrderStatus() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/order_statuses').then(function (response) {
        ...
        _this14.order_status = data.data.filter(function (status) {
    ...
    getProduct: function getProduct() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/products/edit/' + this.id).then(function (response) {
        var data = response.data;
        if (data.status === 1) {
          var _this16$record$indica;
          _this16.record = data.data;
          _this16.name = _this16.record.name;
          _this16.slug = _this16.record.slug;
          _this16.barcode = _this16.record.barcode;
          if (_this16.clone) {
            _this16.name = '';
            _this16.slug = '';
            _this16.barcode = '';
          }
          _this16.seller_id = _this16.record.seller_id;
          _this16.getSellerCategories();
          _this16.getSeller();
          _this16.tag_ids = _this16.record.tags.map(function (item) {
            return item.id;
          });
          _this16.tax_id = _this16.record.tax_id;
          _this16.brand = _this16.brands.find(function (item) {
            return item.id === _this16.record.brand_id;
          });
          _this16.type = _this16.record.type;
          _this16.category_id = _this16.record.category_id;
          _this16.product_type = (_this16$record$indica = _this16.record.indicator) !== null && _this16$record$indica !== void 0 ? _this16$record$indica : "";
          _this16.manufacturer = _this16.record.manufacturer;
          _this16.made_in = _this16.countries.find(function (item) {
            return item.id == _this16.record.made_in;
          });
          _this16.tax_included_in_price = _this16.record.tax_included_in_price;
          _this16.return_status = _this16.record.return_status;
          _this16.return_days = _this16.record.return_days;
          _this16.cancelable_status = _this16.record.cancelable_status;
          _this16.till_status = _this16.record.till_status;
          _this16.cod_allowed_status = _this16.record.cod_allowed;
          _this16.max_allowed_quantity = _this16.record.total_allowed_quantity;
          _this16.description = _this16.record.description;
          _this16.is_approved = _this16.record.is_approved;
          _this16.status = _this16.record.status;
          _this16.is_unlimited_stock = _this16.record.is_unlimited_stock;
          _this16.main_image_path = _this16.$storageUrl + _this16.record.image;
          _this16.other_images = _this16.record.images;
          _this16.fssai_lic_no = _this16.record.fssai_lic_no;
          _this16.image = _this16.record.image;
          _this16.meta_title = _this16.record.meta_title;
          _this16.meta_keywords = _this16.record.meta_keywords;
          _this16.schema_markup = _this16.record.schema_markup;
          _this16.meta_description = _this16.record.meta_description;
          var vm = _this16;
          if (_this16.type == 'packet') {
            _this16.inputs = [];
            _this16.record.variants.forEach(function (item) {
              var variantData = {
                'id': item.id ? item.id : "",
          ...
          if (_this16.type == 'loose') {
            ...
            _this16.loose_stock = loose_stock;
            _this16.loose_stock_unit_id = loose_stock_unit_id;
            _this16.status = status;
          }
        } else {
    ...
    deleteImage: function deleteImage(index, id, productImage) {
      ...
      this.$swal.fire({
        ...
        if (result.value) {
          _this18.deleteImageIds.push(id);
          if (productImage) {
            _this18.other_images.splice(index, 1);
          } else {
            if (_this18.type === 'packet') {
              _this18.inputs[key].images.splice(index, 1);
            } else {
              _this18.inputs[key].loose_images.splice(index, 1);
            }
          }
        }
      });
    ...
    restoreCache: function restoreCache() {
      ...
      try {
        ...
        Object.keys(data).forEach(function (key) {
          if (key === 'timestamp' || key === 'brand' || key === 'made_in') return;
          if (_this19.hasOwnProperty(key)) _this19[key] = data[key] !== undefined ? data[key] : _this19[key];
        });
        if (data.brand && this.brands && this.brands.length) {
          this.brand = this.brands.find(function (b) {
                      ...
                      [
                        ...
                        _c("div", { staticClass: "col-md-6" }, [
                          _c("div", { staticClass: "form-group mt-3" }, [
                            _c(
                              ...
                              {
                                staticClass:
                                  "btn btn-outline-primary mt-2 ai-generate-btn",
                                attrs: {
                                  type: "button",
                                  disabled: _vm.isGeneratingAI,
                                },
                                on: { click: _vm.generateDescription },
                              },
                              [
                                _vm.isGeneratingAI
                                  ? [
                          ...
                          _c("div", { staticClass: "form-group mt-3" }, [
                            _c("label", [
                              _c("input", {
                                ...
                                attrs: { type: "checkbox" },
                                domProps: {
                                  checked: Array.isArray(_vm.useCustomPrompt)
                                    ? _vm._i(_vm.useCustomPrompt, null) > -1
                                    : _vm.useCustomPrompt,
                                },
                                on: {
                                  change: function ($event) {
                                    ...
                                    if (Array.isArray($$a)) {
                                      ...
                                      if ($$el.checked) {
                                        $$i < 0 &&
                                          (_vm.useCustomPrompt = $$a.concat([
                                            $$v,
                                          ]))
                                      } else {
                                        $$i > -1 &&
                                          (_vm.useCustomPrompt = $$a
                                            .slice(0, $$i)
                                            .concat($$a.slice($$i + 1)))
                                      }
                                    } else {
                              ...
                              _vm._v(
                                "\n                                                " +
                                  _vm._s(_vm.__("use_custom_prompt")) +
                                  "\n                                            "
                              ),
                            ]),
                          ]),
                        ...
                        _vm.useCustomPrompt
                          ? _c("div", { staticClass: "form-group mt-2" }, [
                              _c("label", [
                                _vm._v(_vm._s(_vm.__("custom_prompt"))),
                              ]),
                              _vm._v(" "),
                              _c("textarea", {
                                directives: [
                                ...
                                domProps: { value: _vm.customPrompt },
                                on: {
                                  input: function ($event) {
                                    if ($event.target.composing) {
                                      return
                  ...
                  _c("div", { staticClass: "card-body" }, [
                    _c("div", { staticClass: "row" }, [
                      _c("div", { staticClass: "col-md-6" }, [
                        ...
                        _c("div", { staticClass: "form-group" }, [
                          _c("label", [
                            _vm._v(_vm._s(_vm.__("schema_markup")) + " "),
                          ]),
                          _vm._v(" "),
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.schema_markup,
                                expression: "schema_markup",
                              },
                            ],
                            staticClass: "form-control",
                            attrs: {
                            ...
                            domProps: { value: _vm.schema_markup },
                            on: {
                              input: function ($event) {
                                if ($event.target.composing) {
                                  return
                                }
                                _vm.schema_markup = $event.target.value
                              },
                            },
                          }),
                        ]),

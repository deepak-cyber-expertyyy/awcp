...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getFaqs: function getFaqs() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/subscription_faqs/', {
        ...
        if (response.data.status === 1) {
          _this.allFaqs = response.data.data || [];
          _this.totalRows = response.data.total || _this.allFaqs.length;
          // Update displayed FAQs based on current mode
          if (_this.enableDragDrop) {
            // When drag-drop is enabled, show all FAQs
            _this.faqs = _toConsumableArray(_this.allFaqs);
          }
    ...
    deleteFaq: function deleteFaq(index, id) {
      ...
      this.$swal.fire({
        ...
        if (result.value) {
          ...
          axios__WEBPACK_IMPORTED_MODULE_1___default().post(_this2.$apiUrl + "/subscription_faqs/delete/".concat(id)).then(function (response) {
            _this2.isLoading = false;
            if (response.data.status === 1) {
              // Remove from both faqs and allFaqs arrays
              var allFaqsIndex = _this2.allFaqs.findIndex(function (faq) {
                return faq.id === id;
              });
              if (allFaqsIndex !== -1) {
                _this2.allFaqs.splice(allFaqsIndex, 1);
              }

              // Remove from faqs array (for drag-drop mode)
              if (_this2.enableDragDrop) {
                var faqsIndex = _this2.faqs.findIndex(function (faq) {
                  return faq.id === id;
                });
                if (faqsIndex !== -1) {
                  _this2.faqs.splice(faqsIndex, 1);
                }
              }
              _this2.totalRows = _this2.allFaqs.length;
    ...
    saveFaq: function saveFaq() {
      ...
      if (this.form.id) {
        url = this.$apiUrl + "/subscription_faqs/update/".concat(this.form.id);
      }
      axios__WEBPACK_IMPORTED_MODULE_1___default().post(url, formData).then(function (response) {
        ...
        if (error.response && error.response.data && error.response.data.message) {
          _this3.showError(error.response.data.message);
        } else {
    ...
    updateFaqsOrder: function updateFaqsOrder() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().post(this.$apiUrl + '/subscription_faqs/update_order', {
        ...
        _this4.isUpdatingOrder = false;
        if (response.data.status === 1) {
          _this4.showMessage("success", response.data.message || __('order_updated_successfully'));
          // Update allFaqs to reflect new order
          _this4.allFaqs = _toConsumableArray(_this4.faqs);
        } else {
                  ...
                  [
                    _c("ol", { staticClass: "breadcrumb" }, [
                      ...
                      _c(
                        ...
                        [_vm._v(_vm._s(_vm.__("subscription_faqs")))]
                      ),
                    ]),
                  ]
                ),
              ...
              _c("div", { staticClass: "row" }, [
                _c("div", { staticClass: "col-md-12" }, [
                  _c("div", { staticClass: "form-group" }, [
                    ...
                    _c("small", { staticClass: "text-muted" }, [
                      _vm._v(_vm._s(_vm.__("enter_the_faq_question"))),
                    ]),
                  ]),
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "col-md-12" }, [
                  _c("div", { staticClass: "form-group" }, [
                    ...
                    _vm._v(" "),
                    _c("small", { staticClass: "text-muted" }, [
                      _vm._v(_vm._s(_vm.__("enter_the_faq_answer_optional"))),
                    ]),
                  ]),
                ]),
                _vm._v(" "),
                  ...
                  _c("div", { staticClass: "form-group" }, [
                    ...
                    _c("input", {
                      ...
                      attrs: {
                        ...
                        name: "sort_order",
                        id: "sort_order",
                        placeholder: _vm.__("enter_sort_order"),
                        min: "0",
                      },
                    ...
                    _vm._v(" "),
                    _c("small", { staticClass: "text-muted" }, [
                      _vm._v(_vm._s(_vm.__("lower_numbers_appear_first"))),
                    ]),
                  ]),
                ]),
                _vm._v(" "),

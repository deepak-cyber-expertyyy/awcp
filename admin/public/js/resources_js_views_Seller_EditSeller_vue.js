  ...
  methods: {
      ...
      try {
        ...
        Object.keys(data).forEach(function (key) {
          ...
          if (key === 'storeTimings' && data.storeTimings) {
            _this6.storeTimings = data.storeTimings;
          } else if (_this6.hasOwnProperty(key)) {
            _this6[key] = data[key] !== undefined ? data[key] : _this6[key];
          }
        });
    ...
    getSeller: function getSeller() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/sellers/edit/' + this.id).then(function (response) {
        ...
        var data = response.data;
        if (data.status === 1) {
          var _this9$record$admin$i, _this9$record$admin$u, _this9$record$admin$e, _this9$record$city_id, _this9$record$categor;
                ...
                _c("div", { staticClass: "card" }, [
                  ...
                  _c("div", { staticClass: "card-body" }, [
                    _c("div", { staticClass: "row" }, [
                      ...
                      _vm._v(" "),
                      _vm.store_settings.self_pickup_mode == 1
                        ? _c("div", { staticClass: "form-group col-md-3" }, [
                            _c(
                              "div",
                              { staticClass: "form-group" },
                        ...
                        ? _c("div", { staticClass: "form-group col-md-3" }, [
                            _c(
                              ...
                              [
                                _c("label", { staticClass: "control-label" }, [
                                  _vm._v(
                                    " " + _vm._s(_vm.__("self_pickup_mode"))
                                  ),
                                ]),
                                _c("br"),
                                _vm._v(" "),
                      ...
                      ? _c("div", { staticClass: "row mt-4" }, [
                          _c("div", { staticClass: "col-12" }, [
                            _c("h5", { staticClass: "text-primary" }, [
                              _vm._v(
                                _vm._s(_vm.__("self_pickup_configuration"))
                              ),
                            ]),
                          ]),
                          _vm._v(" "),
                            ...
                            _c("div", { staticClass: "row" }, [
                                          ...
                                          _c(
                                            "gmap-info-window",
                                            {
                                              attrs: {
                                                ...
                                                position:
                                                  _vm.pickupInfoWindow.position,
                                                opened:
                                                  _vm.pickupInfoWindow.open,
                                              },
                                              on: {
                                                closeclick: function ($event) {
                              ...
                              _c("div", { staticClass: "col-md-6" }, [
                                _c(
                                  ...
                                  [
                                    ...
                                    _c("GmapAutocomplete", {
                                      ...
                                      on: { place_changed: _vm.setPickupPlace },
                                    }),
                                    _vm._v(" "),
                                    _c(
                                      "span",
                                ...
                                _c("div", { staticClass: "form-group" }, [
                                  _c("label", [
                                    _vm._v(
                                      _vm._s(_vm.__("pickup_store_address")) +
                                        " "
                                    ),
                                    _c("i", { staticClass: "text-danger" }, [
                                      _vm._v("*"),
                                ...
                                _c("div", { staticClass: "form-group" }, [
                                  ...
                                  _c("input", {
                                    ...
                                    domProps: { value: _vm.pickup_latitude },
                                    on: {
                                      input: function ($event) {
                                        if ($event.target.composing) {
                                          return
                                ...
                                _c("div", { staticClass: "form-group" }, [
                                  ...
                                  _c("input", {
                                    ...
                                    domProps: { value: _vm.pickup_longitude },
                                    on: {
                                      input: function ($event) {
                                        if ($event.target.composing) {
                                          return
                                ...
                                _c("div", { staticClass: "form-group" }, [
                                  ...
                                  _c("div", { staticClass: "row" }, [
                                    _c("div", { staticClass: "col-md-6" }, [
                                      _c(
                                        ...
                                        [_vm._v(_vm._s(_vm.__("opening_time")))]
                                      ),
                                      _vm._v(" "),
                                      _c("input", {
                                        directives: [
                                    ...
                                    _c("div", { staticClass: "col-md-6" }, [
                                      _c(
                                        "label",
                                        { staticClass: "form-label" },
                                        [_vm._v(_vm._s(_vm.__("closing_time")))]
                                      ),
                                      _vm._v(" "),
                                      _c("input", {
                                        directives: [
                                  ...
                                  _c("small", { staticClass: "text-muted" }, [
                                    _vm._v(
                                      _vm._s(
                                        _vm.__("store_timings_description")
                                      )
                                    ),
                                  ]),
                                ]),

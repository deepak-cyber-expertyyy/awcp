...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getPaymentMethods: function getPaymentMethods() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(this.$apiUrl + '/payment_methods').then(function (response) {
        if (response.data.data) {
          var _this$record$payment_, _this$record$cod_paym, _this$record$cod_mode, _this$record$paypal_m, _this$record$paypal_c, _this$record$paypal_n, _this$record$payumone, _this$record$paystack, _this$record$flutterw, _this$record$stripe_w, _this$record$ssl_comm;
    ...
    saveRecord: function saveRecord() {
      ...
      this.payment_method.midtrans_payment_method == 1 || this.payment_method.phonepay_payment_method == 1 || this.payment_method.cashfree_payment_method == 1 || this.payment_method.paytabs_payment_method == 1) {

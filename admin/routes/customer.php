...
Route::group(['middleware' => ['auth.customer']], function () {
    ...
    Route::get('blogs', [\App\Http\Controllers\API\BlogsApiController::class, 'getBlogs']);
    Route::get('blog_categories', [\App\Http\Controllers\API\BlogsApiController::class, 'getBlogCategories']);
    ...
    Route::get('subscription_plans', [\App\Http\Controllers\API\SubscriptionPlansApiController::class, 'getPlans']);
    Route::get('subscription_faqs', [\App\Http\Controllers\API\SubscriptionPlansApiController::class, 'getFaqs']);
    //Languages

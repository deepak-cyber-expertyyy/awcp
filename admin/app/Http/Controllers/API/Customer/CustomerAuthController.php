...
class CustomerAuthController extends Controller
{
            ...
            if ($user) {
                ...
                if ($request->type == 'email') {
                    ...
                    try {
                        ...
                        $user->save();
                        // Set default mail settings for newly registered user
    ...
    public function getLoginUserDetails(Request $request)
    {
        ...
        if (!empty($user)) {
            ...
            // Add subscription-related fields to user object
            ...
            $user->user_subscription_plan_name = $userSubscription ? $userSubscription->plan_name : '';

...
class OrderApiController extends Controller
{
    ...
    public function initiateTransaction(Request $request)
    {
        ...
        if ($request->payment_method == "Razorpay") {
            ...
            if ($request->type == 'order') {
                ...
                $response = TransactionHelper::createOrderOnStripe($subscription_amount, $request->subscription_plan_id);
            }
    ...
    public function addTransaction(Request $request)
    {
        ...
        if ($request->payment_method == Transaction::$paymentTypeInAppPurchase) {
            ...
            $transactionData['type'] = Transaction::$paymentTypeInAppPurchase;
            ...
            $transactionData['message'] = "Subscription payment via iOS In-App Purchase";
    ...
    public function getOrderStatusPhonepe(Request $request)
    {
        ...
        try {
            ...
            if (!$paymentDetails || !$metaInfo) {
                Log::error('PhonePe status missing data', ['payload' => $statusPayload]);

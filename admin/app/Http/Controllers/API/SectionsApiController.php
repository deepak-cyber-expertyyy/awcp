...
class SectionsApiController extends Controller
{
    ...
    public function save(Request $request){
        ...
        $section->category_ids = ($request->product_type == 'recently_visited_products') ? "" : ($request->category_ids ?? "");
        $section->product_type = $request->product_type;
        $section->product_ids = ($request->product_type == 'recently_visited_products') ? null : $request->product_ids;
    ...
    public function update(Request $request){
        ...
        if(isset($request->id)){
            ...
            $section->category_ids = ($request->product_type == 'recently_visited_products') ? "" : ($request->category_ids ?? "");
            $section->product_type = $request->product_type;
            $section->product_ids = ($request->product_type == 'recently_visited_products') ? null : (($request->product_type == 'custom_products') ? $request->product_ids : null);
            $section->position = $request->position;
            $section->style_app = $request->style_app;
